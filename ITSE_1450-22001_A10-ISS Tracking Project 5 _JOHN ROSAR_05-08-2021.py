...
def getLocation(ISS_Posit):
    for i in range(6):
        print("")
        print("The current distance of the ISS to Richland College is -","{:0.1f}".format(ISS_Dist), "miles.")
        print("The current Latitude and Longitude of the ISS is - ", ISS_Posit)
        print("")
